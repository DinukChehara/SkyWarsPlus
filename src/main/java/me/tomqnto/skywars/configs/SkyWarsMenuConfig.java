...
public class SkyWarsMenuConfig {
    ...
    public final static File file = new File(SkywarsPlus.getInstance().getDataFolder(), "menus/skywars_menu.yml");
    public static FileConfiguration config;


    static {
        if (!file.exists())
            SkywarsPlus.getInstance().saveResource("menus/skywars_menu.yml", false);
